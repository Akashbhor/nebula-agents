...
| `a2a-engineer` | implementing agent cards, streaming task APIs, and remote-agent transport | feature folder, architecture docs, agent-card requirements, remote integration contracts | `{PRODUCT_ROOT}/neuron/**`, feature `STATUS.md`, feature `GETTING-STARTED.md`, `{PRODUCT_ROOT}/neuron/README.md` | protocol-level integration tests and A2A transport validation commands |
...
- `a2a-engineer`: `Switch to A2A Engineer agent mode (agents/a2a-engineer/SKILL.md).`
