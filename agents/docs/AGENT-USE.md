...
| `nebula-adapter` | framework routing and backend stack packs | `agents/TECH-STACK-ADAPTATION.md`, `agents/ROUTER.md`, `agents/docs/CONTAINER-STRATEGY.md`, `blueprint-setup/README.md`, `agents/nebula-adapter/references/framework-compatibility-guide.md`, `agents/nebula-adapter/references/stack-pack-routing-guide.md` | `agents/README.md`, `agents/ROUTER.md`, `agents/TECH-STACK-ADAPTATION.md`, `agents/docs/CONTAINER-STRATEGY.md`, `agents/docs/AGENT-USE.md`, `blueprint-setup/README.md` | confirm routing/doc updates mention the new backend stack explicitly |
| `backend-developer` | implementing `{PRODUCT_ROOT}/engine/` changes from approved feature plans | feature folder, `feature-assembly-plan.md`, `{PRODUCT_ROOT}/planning-mds/api/`, `{PRODUCT_ROOT}/planning-mds/schemas/`, `{PRODUCT_ROOT}/planning-mds/architecture/SOLUTION-PATTERNS.md`, `agents/backend-developer/references/stack-packs/README.md` | `{PRODUCT_ROOT}/engine/**`, feature `STATUS.md`, feature `GETTING-STARTED.md` | `python3 {PRODUCT_ROOT}/scripts/kg/hint.py <path>` before searching, `sh agents/backend-developer/scripts/run-tests.sh --strict` or repo-standard backend test command |
| `frontend-developer` | implementing `{PRODUCT_ROOT}/experience/` screens, forms, API wiring, UX fixes | feature folder, `feature-assembly-plan.md`, screen specs, `{PRODUCT_ROOT}/planning-mds/api/`, `{PRODUCT_ROOT}/planning-mds/schemas/`, `agents/frontend-developer/references/ux-audit-ruleset.md`, `agents/frontend-developer/references/stack-packs/README.md` | `{PRODUCT_ROOT}/experience/**`, feature `STATUS.md`, feature `GETTING-STARTED.md` | `python3 {PRODUCT_ROOT}/scripts/kg/hint.py <path>` before searching, `pnpm --dir {PRODUCT_ROOT}/experience lint`, `pnpm --dir {PRODUCT_ROOT}/experience lint:theme`, `pnpm --dir {PRODUCT_ROOT}/experience build`, `pnpm --dir {PRODUCT_ROOT}/experience test`, plus `pnpm --dir {PRODUCT_ROOT}/experience test:visual:theme` when theme/styling changed |
