...
Key principles: use multi-stage builds, non-root users, health checks,
resource limits, secrets management, specific image tags, stdout logging, and monitoring.
